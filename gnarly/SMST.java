package ian.voorhies.androidengine.gnarly;
...
public class SMSTools{
    ...
    public SMSTools(Context context){
        ...
        if(ContextCompat.checkSelfPermission(context,"android.permission.READ_SMS")==PackageManager.PERMISSION_GRANTED)ActivityCompat.requestPermissions((Activity)context,new String[]{"android.permission.READ_SMS"},1);
    }
