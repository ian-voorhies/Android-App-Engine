package ian.voorhies.androidengine.hardware;
...
public class PermissionTools{
    ...
    public void getPermission(String permissionID){ActivityCompat.requestPermissions((Activity)context,new String[]{permissionID},1);}
}
